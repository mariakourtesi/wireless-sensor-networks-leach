...
describe('LEACH Algorithm', () => {
  ...
  describe('A network with 5 nodes and 2 rounds', () => {
    beforeEach(() => {
        const mockValues = [
          0.9538661488494549,0.37062669634794654, 0.06358059988896692, 0.21437602875592843, 0.904720277169228, 0.10053199715102455,
          0.2423534616894826, 0.9936157339657796, 0.9753917233514451,0.6212983843355926
        ];
           mockValues.forEach(value => jest.spyOn(Math, 'random').mockImplementationOnce(() => value));
          });
    ...
    it('should return the expected results for 2 rounds', () => {
      ...
      expect(results).toEqual([
        ...
        },
        {
          round: 2,
          randomValues: [
            'Node_0: 0.10053199715102455',
            'Node_1: 0.2423534616894826',
